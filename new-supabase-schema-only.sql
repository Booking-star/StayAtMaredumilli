-- Stay@Maredumilli new Supabase schema-only setup
-- Generated: 2026-07-13 20:58:36 +05:30
-- Purpose: create tables, views, functions, RLS policies, grants, realtime setup, and default site settings.
-- This file intentionally does NOT migrate hotel rooms, bookings, customers, owners, highlights, influencers, or storage objects.
...
-- ============================================================================
-- Source: storage-rls-hardening-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: security-hardening-rls-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: security-hardening-booking-rpc-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: admin-customers-bookings-permissions-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: upcoming-bookings-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: owner-release-offline-only-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: offline-booking-hold-capacity-migration.sql
-- ============================================================================

-- Keep admin/owner offline blocks in sync with active Razorpay room holds.
...
-- ============================================================================
-- Source: manual-upi-payment-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: payment-hold-15min-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: payment-confirm-capacity-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: payment-confirm-expired-hold-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: payment-default-razorpay-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: payment-settings-rpc-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: realtime-sync-migration.sql
-- ============================================================================
...
begin
  ...
  if not exists (
    select 1 from pg_publication_tables
    where pubname = 'supabase_realtime' and schemaname = 'public' and tablename = 'booking_holds'
  ) then
...
-- ============================================================================
-- Source: booking-guest-count-validation-migration.sql
-- ============================================================================
...
-- ============================================================================
-- Source: booking-email-notifications-migration.sql
-- ============================================================================
...
-- ============================================================================
-- New Supabase owner list view
-- ============================================================================
-- Admin UI reads this view to show owner email beside hotel owner details.
-- This does not create Auth users. Owner Auth creation/update must be exported
-- from the live project or moved to a Vercel API before owner registration works.
